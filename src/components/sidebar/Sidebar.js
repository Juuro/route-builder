...
const Sidebar = () => {
    ...
    const [isSidebarUp, toggleSidebarPosition] = useToggle(false)
    ...
    return (
        <aside className={`sidebar ${isSidebarUp ? 'up' : 'down'}`}>
            <button type="button" className="sidebar-position-toggle button-no-button" onClick={toggleSidebarPosition} title="Click to see all waypoints as a list">
